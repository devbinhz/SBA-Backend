...
public class RefundRequestMapper {
    ...
    public RefundRequestResponseDTO toResponse(RefundRequest refundRequest, List<RefundRequestItem> items, List<RefundEvidence> evidence) {
        return RefundRequestResponseDTO.builder()
                ...
                .changeOfMindAcknowledged(refundRequest.getChangeOfMindAcknowledged())
                ...
                .resolutionType(refundRequest.getResolutionType())
                ...
                .replacementShippingProvider(refundRequest.getReplacementShippingProvider())
                .replacementTrackingCode(refundRequest.getReplacementTrackingCode())
                .replacementShippedAt(refundRequest.getReplacementShippedAt())
